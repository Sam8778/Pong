...
-- speed at which we will move our paddle; multiplyed by dt in update
PADDLE_SPEED = 200
...
function love.load()
    ...
    -- velocity and postion variables for our ball when play starts
...
function love.draw()
    ...
    -- render first paddle (left side) now using the player's Y variable
